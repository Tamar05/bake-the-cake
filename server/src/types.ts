...
export type RequestDraft = {
  ...
  location: string; // a real town name (see towns.ts), or "Other: <free text>" if not in the list
...
export type CakeRequest = RequestDraft & {
  ...
  galleryCaption: string; // optional message shown with the photo in the gallery ('' if none)
};
