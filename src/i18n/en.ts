...
export const en: Dictionary = {
  ...
  notifications: {
    ...
    dietaryLabel: 'Dietary needs you can make',
    kashrutLabel: 'Kashrut levels you cook with',
    save: 'Save settings',
    saving: 'Saving…',
    saved: 'Saved ✓',
  ...
  auth: {
    ...
    bakerCapabilitiesNote: 'What can you make? You can change these anytime in Notifications.',
